...
// Modelo para el resumen del día
class ResumenDia {
  ...
  // Estado vacío para cuando no hay ventas aún
...
// FutureProvider llama a la API y maneja loading/error automáticamente
final resumenDiaProvider = FutureProvider<ResumenDia>((ref) async {
  final response = await ApiClient.get('/reportes/vendedor/hoy');
